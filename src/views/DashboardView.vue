...
import { formatDateCN, isUpcoming, formatCurrency, formatCNY, getOrderStatusColor } from '@/utils'
...
const statsCards = computed(() => [
  ...
  },
  {
    ...
    sub: `待办 ${store.pendingOrderCount} · 合计 ${formatCNY(store.totalOrderAmountCNY)}`,
    icon: '🎫',
  ...
  <div class="space-y-6 md:space-y-7" id="dashboard-view">
    ...
    <div class="page-header">
      ...
      <div class="hidden md:block">
        <span class="sticker-badge sticker-badge--sky text-sm">
    ...
    <div class="trip-card trip-card--pink p-5 md:p-7 pt-8 relative overflow-hidden">
      <div class="relative">
        ...
        <div class="flex flex-wrap items-start gap-3 mb-5">
          ...
          <span class="sticker-badge sticker-badge--lemon text-base mt-1">
        ...
        <div class="flex flex-wrap gap-4 items-start">
          <div class="sticky-note sticky-note--pink max-w-xs">
            <div class="text-xs text-ink-600 mb-1">📌 旅行时间</div>
          ...
          <!-- 倒计时贴纸 -->
          <div class="sticker-badge sticker-badge--sky py-2 px-4 text-sm">
            ⏳ 还有
            <span class="text-2xl font-extrabold mx-1">
        ...
        <div class="mt-6 bg-white/60 rounded-2xl p-4 border-2 border-dashed border-strawberry-200">
          <div class="flex justify-between text-xs md:text-sm mb-2">
            <span class="font-bold text-ink-700">💖 准备进度</span>
          ...
          <div class="h-4 bg-lemon-50 rounded-full overflow-hidden border-2 border-lemon-200">
            <div
              ...
              style="background: linear-gradient(90deg, #a7e09a 0%, #70c86d 60%, #4ea852 100%)"
              :style="{
                width: `${Math.min(
                  100,
                  Math.round(
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
      ...
      >
        ...
        <!-- 大数字 -->
        <div class="text-3xl md:text-4xl font-extrabold text-ink-800 my-1">
          {{ card.value }}
        </div>

        <!-- 副标题 -->
        <div class="text-xs md:text-sm text-ink-500 mt-1">
          {{ card.sub }}
        </div>
        ...
        <div v-if="nearestDaySchedule">
          ...
          <div class="sticky-note sticky-note--mint mb-4">
            <div class="flex items-center justify-between">
              <div>
                <span class="sticker-badge sticker-badge--mint !px-2 !py-0.5 !text-[10px]">
          ...
          <div class="space-y-3">
            ...
            >
              ...
              <p class="text-ink-600">这一天还没有安排行程~</p>
              <button
                v-if="store.canEdit"
            ...
            <template v-else>
              ...
              >
                ...
                />
                <!-- 便签条目 -->
                <div class="sticky-note sticky-note--mint p-3">
                  <div class="flex items-baseline gap-2 flex-wrap">
                    <span class="sticker-badge sticker-badge--sky !px-2 !py-0.5 !text-[10px] shrink-0">
                      ⏰ {{ item.timeStart || '--:--' }}
                    </span>
                  ...
                  <div class="mt-1.5 text-xs text-ink-600 flex flex-wrap gap-2">
            ...
            <div
              ...
              class="text-center text-sm text-ink-400 pt-1"
            >
        ...
        <div v-else class="space-y-3">
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              ...
              <div v-if="cityWeathers[code]?.current" class="mt-0.5 text-xs text-ink-600 truncate">
                {{ cityWeathers[code].current.description }}
              </div>
            </div>
            <div class="text-right shrink-0">
              <div class="text-2xl font-extrabold text-ink-800">
    ...
    >
      <div class="flex items-center gap-3 mb-5">
        ...
        <span class="sticker-badge sticker-badge--pink !text-[11px]">
          3天内使用 · 请提前确认
        </span>
      </div>
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <div class="text-right shrink-0">
            <div class="text-xl font-extrabold text-strawberry-600">
