// ================================
// 内联 SVG 图标组件库（无第三方图标库，零依赖）
// 所有图标基于 Lucide/Feather 风格，stroke 宽度 2
// ================================
...
/** 创建 SVG 图标工厂 */
const makeIcon = (paths: string, viewBox = '0 0 24 24'): DefineComponent<IconProps> => {
  return {
    name: 'Icon',
    props: {
...
export const IconMoon = makeIcon('<path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8z"/>')
...
export const IconCloudSnow = makeIcon(
  '<path d="M17.5 19a4.5 4.5 0 1 0-1.3-8.8 6 6 0 0 0-11.6 2A4 4 0 0 0 5 19h12.5z"/><path d="M8 20h.01M12 22h.01M16 20h.01M10 17h.01M14 17h.01"/>'
)
export const IconCloudSun = makeIcon(
  '<circle cx="7" cy="8" r="3"/><path d="M4.5 9.5L3 8.5M9.5 4.5L8.5 3M11.5 9.5L13 8.5M9.5 13L8.5 14.5"/><path d="M18 17a3.5 3.5 0 0 0 .7-7 5 5 0 0 0-9.4 1.5"/>'
)
